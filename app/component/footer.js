...
export const Footer=()=>{
    return(
        <div className="w-full h-[1120px] relative ">
            ...
            <div className="flex gap-6 absolute inset-0 justify-center items-center">
                ...
                <button className="w-[384px] h-[527px] bg-white rounded-3xl flex flex-col items-start justify-start p-8 gap-3">
         ...
         <p className="text-[16px] font-normal text-[#3f3f46] leading-relaxed">
  ...
  <p className="flex-1 text-[16px] font-medium text-[#3f3f46] leading-snug text-left">
...
<div className="mb-10">
<button
  className="rounded-3xl h-12 flex justify-center items-center
             bg-[#a4d1e2] text-black w-[336px] mt-9
             text-[16px] font-semibold
             transition-colors duration-300
             hover:bg-black hover:text-white relative z-10"
>
  Select package
</button>
               </div>
